	...
	public AjouterPlanning() {
		...
		butAjouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String dateDebut1 = dateD.getDate().getYear() + "" + dateD.getDate().getMonth()
						+ dateD.getDate().getDate();
				String dateFin1 = dateF.getDate().getYear() + "" + dateF.getDate().getMonth()
						+ dateF.getDate().getDate();
				...
				if ((textField.getText().isEmpty()) || (dateDebut1 == null) || (dateF.getDate() == null)) {
					...
					if (dateDebut1.equals(dateFin1)) {
						JOptionPane.showMessageDialog(butAjouter,
								"La date de debut doit etre differente de la date de fin\n \n                  Svp réssayez",
						...
						if ((!(textField.getText().isEmpty())) && (!(dateDebut1 == null)) && (!(dateFin1 == null))
							...
							JOptionPane.showMessageDialog(null,
									"La date de fin doit etre situé aprés la date début\n \n                  Svp réssayez",
									"Erreur", JOptionPane.ERROR_MESSAGE);
