	...
	public Disponibilite() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String dateDebut = AjouterPlanning.dateD.getDate().getYear() + ""
						+ AjouterPlanning.dateD.getDate().getMonth() + AjouterPlanning.dateD.getDate().getDate();
				String dateFin = AjouterPlanning.dateF.getDate().getYear() + ""
						+ AjouterPlanning.dateF.getDate().getMonth() + AjouterPlanning.dateF.getDate().getDate();
				...
				if (dateChoisie_int < dateDebut_int || dateChoisie_int > dateFin_int) {
					JOptionPane.showMessageDialog(btnAjouter,
							"La date doit se situer entre le  "
									+ (String.format("%1$td/%1$tm/%1$tY", AjouterPlanning.dateD.getDate().getTime()))
									+ " et le "
									+ (String.format("%1$td/%1$tm/%1$tY", AjouterPlanning.dateF.getDate().getTime()))
									+ " \n \n                  Svp réssayez",
